...
const jwksUrl = 'https://dev-y5-kxxnn.eu.auth0.com/.well-known/jwks.json' //https://dev-y5-kxxnn.eu.auth0.com/.well-known/jwks.json
...
export const handler = async (
  ...
  try {
    ...
    logger.error('Userek not authorized', { error: e.message })
